...
export const AH_STOCKS: AHStockPair[] = [
    ...
    { aCode: '002399', hCode: '02399', name: '海普瑞', industry: '医药' },
...
/**
 * AH股票补充列表（来自新增清单，尚未归类行业）
 */
export const AH_STOCKS_NOCHECK: AHStockPair[] = [
    // 金融
    ...
    { aCode: '601717', hCode: '01717', name: '中创智领', industry: '制造' },
